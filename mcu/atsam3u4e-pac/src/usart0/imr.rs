...
#[doc = "Field `ENDRX` reader - End of Receive Transfer Interrupt Mask"]
pub type ENDRX_R = crate::BitReader;
#[doc = "Field `ENDTX` reader - End of Transmit Interrupt Mask"]
...
#[doc = "Field `ITER` reader - Max number of Repetitions Reached Mask"]
pub type ITER_R = crate::BitReader;
#[doc = "Field `UNRE` reader - SPI Underrun Error Mask"]
