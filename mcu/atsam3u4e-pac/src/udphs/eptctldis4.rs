...
#[doc = "Field `RX_BK_RDY` writer - Received OUT Data Interrupt Disable"]
...
#[doc = "Field `TX_PK_RDY` writer - TX Packet Ready/Transaction Error Interrupt Disable"]
pub type TX_PK_RDY_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `ERR_TRANS` writer - TX Packet Ready/Transaction Error Interrupt Disable"]
pub type ERR_TRANS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `RX_SETUP` writer - Received SETUP/Error Flow Interrupt Disable"]
pub type RX_SETUP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `ERR_FL_ISO` writer - Received SETUP/Error Flow Interrupt Disable"]
pub type ERR_FL_ISO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `STALL_SNT` writer - Stall Sent/ISO CRC Error/Number of Transaction Error Interrupt Disable"]
pub type STALL_SNT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `ERR_CRISO` writer - Stall Sent/ISO CRC Error/Number of Transaction Error Interrupt Disable"]
pub type ERR_CRISO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `ERR_NBTRA` writer - Stall Sent/ISO CRC Error/Number of Transaction Error Interrupt Disable"]
pub type ERR_NBTRA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `NAK_IN` writer - NAKIN/bank flush error Interrupt Disable"]
pub type NAK_IN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `ERR_FLUSH` writer - NAKIN/bank flush error Interrupt Disable"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datax_rx(&mut self) -> DATAX_RX_W<EPTCTLDIS4_SPEC, 6> {
        DATAX_RX_W::new(self)
    }
    #[doc = "Bit 7 - MDATA Interrupt Disable (Only for High Bandwidth Isochronous OUT endpoints)"]
    #[inline(always)]
    #[must_use]
    pub fn mdata_rx(&mut self) -> MDATA_RX_W<EPTCTLDIS4_SPEC, 7> {
        MDATA_RX_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_bk_rdy(&mut self) -> RX_BK_RDY_W<EPTCTLDIS4_SPEC, 9> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_pk_rdy(&mut self) -> TX_PK_RDY_W<EPTCTLDIS4_SPEC, 11> {
        TX_PK_RDY_W::new(self)
    }
    #[doc = "Bit 11 - TX Packet Ready/Transaction Error Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn err_trans(&mut self) -> ERR_TRANS_W<EPTCTLDIS4_SPEC, 11> {
        ERR_TRANS_W::new(self)
    }
    #[doc = "Bit 12 - Received SETUP/Error Flow Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn err_fl_iso(&mut self) -> ERR_FL_ISO_W<EPTCTLDIS4_SPEC, 12> {
        ERR_FL_ISO_W::new(self)
    }
    #[doc = "Bit 13 - Stall Sent/ISO CRC Error/Number of Transaction Error Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn err_criso(&mut self) -> ERR_CRISO_W<EPTCTLDIS4_SPEC, 13> {
        ERR_CRISO_W::new(self)
    }
    #[doc = "Bit 13 - Stall Sent/ISO CRC Error/Number of Transaction Error Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn err_nbtra(&mut self) -> ERR_NBTRA_W<EPTCTLDIS4_SPEC, 13> {
        ERR_NBTRA_W::new(self)
    }
    #[doc = "Bit 14 - NAKIN/bank flush error Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn err_flush(&mut self) -> ERR_FLUSH_W<EPTCTLDIS4_SPEC, 14> {
