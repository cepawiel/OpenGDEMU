...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_bk_rdy(&mut self) -> RX_BK_RDY_W<EPTCLRSTA3_SPEC, 9> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn err_fl_iso(&mut self) -> ERR_FL_ISO_W<EPTCLRSTA3_SPEC, 12> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn err_nbtra(&mut self) -> ERR_NBTRA_W<EPTCLRSTA3_SPEC, 13> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn err_flush(&mut self) -> ERR_FLUSH_W<EPTCLRSTA3_SPEC, 14> {
