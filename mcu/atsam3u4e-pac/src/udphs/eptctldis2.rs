...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datax_rx(&mut self) -> DATAX_RX_W<EPTCTLDIS2_SPEC, 6> {
        DATAX_RX_W::new(self)
    }
    #[doc = "Bit 7 - MDATA Interrupt Disable (Only for High Bandwidth Isochronous OUT endpoints)"]
    #[inline(always)]
    #[must_use]
    pub fn mdata_rx(&mut self) -> MDATA_RX_W<EPTCTLDIS2_SPEC, 7> {
        MDATA_RX_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_bk_rdy(&mut self) -> RX_BK_RDY_W<EPTCTLDIS2_SPEC, 9> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_pk_rdy(&mut self) -> TX_PK_RDY_W<EPTCTLDIS2_SPEC, 11> {
        TX_PK_RDY_W::new(self)
    }
    #[doc = "Bit 11 - TX Packet Ready/Transaction Error Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn err_trans(&mut self) -> ERR_TRANS_W<EPTCTLDIS2_SPEC, 11> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn err_fl_iso(&mut self) -> ERR_FL_ISO_W<EPTCTLDIS2_SPEC, 12> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn err_criso(&mut self) -> ERR_CRISO_W<EPTCTLDIS2_SPEC, 13> {
        ERR_CRISO_W::new(self)
    }
    #[doc = "Bit 13 - Stall Sent/ISO CRC Error/Number of Transaction Error Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn err_nbtra(&mut self) -> ERR_NBTRA_W<EPTCTLDIS2_SPEC, 13> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn err_flush(&mut self) -> ERR_FLUSH_W<EPTCTLDIS2_SPEC, 14> {
