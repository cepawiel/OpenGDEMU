...
#define TRICE_TIMESTAMP ar_get_microseconds() //!< Enable if you need target timestamps. You must provide ReadTime() returning a 32-bit value of your choice, like microSecond.
...
#ifdef TRICE_UART
extern uint32_t loggingUARTTXEmpty(void);
extern void loggingUARTWrite(uint8_t v);
extern void loggingUARTEnableTxEmptyInterrupt(void);
extern void loggingUARTDisableTxEmptyInterrupt(void);
...
TRICE_INLINE void triceEnableTxEmptyInterrupt(void) {
    loggingUARTEnableTxEmptyInterrupt();
}

//! Disallow interrupt for empty trice data transmit register.
//! User must provide this function.
TRICE_INLINE void triceDisableTxEmptyInterrupt(void) {
    loggingUARTDisableTxEmptyInterrupt();
}
